      ...
      <div className="container footer-grid">
        <div className="space-y-4">
          ...
          <div className="flex gap-4">
            ...
            <a href="https://github.com" target="_blank" rel="noreferrer" className="text-slate-400 hover:text-white transition-colors" aria-label="GitHub">
        ...
        <div>
          ...
          <ul className="space-y-2 text-slate-300">
            <li><a href="mailto:info@zentharatechnologies.com" className="hover:text-brand-light transition-colors">info@zentharatechnologies.com</a></li>
            <li>Mumbai, India</li>
          </ul>
        </div>
      </div>
